         ...
         <ul className="menu-inner py-1">
           ...
           <li className="menu-item">
             <a href="javascript:void(0);" className="menu-link menu-toggle">
               ...
               <div data-i18n="Account Settings">Patient list</div>
             </a>
             <ul className="menu-sub">
               <li className="menu-item">
           ...
           <li className="menu-item">
             <a href="javascript:void(0);" className="menu-link menu-toggle">
               ...
               <div data-i18n="Authentications">Patient Sub Profiel list</div>
             </a>
             <ul className="menu-sub">
               <li className="menu-item">
           ...
           <li className="menu-item">
             <a href="javascript:void(0);" className="menu-link menu-toggle">
               ...
               <div data-i18n="Misc">Hospital</div>
             </a>
             <ul className="menu-sub">
               <li className="menu-item">
           ...
           <li className="menu-item">
             <a href="javascript:void(0)" className="menu-link menu-toggle">
               ...
               <div data-i18n="User interface">Designation</div>
             </a>
             <ul className="menu-sub">
               <li className="menu-item">
           ...
           <li className="menu-item">
             <a href="icons-boxicons.html" className="menu-link">
               ...
               <div data-i18n="Boxicons">Schedule</div>
             </a>
           </li>
           ...
           <li className="menu-item">
             <a href="javascript:void(0);" className="menu-link menu-toggle">
               ...
               <div data-i18n="Form Elements">Video Consultancy</div>
             </a>
             <ul className="menu-sub">
               <li className="menu-item">
